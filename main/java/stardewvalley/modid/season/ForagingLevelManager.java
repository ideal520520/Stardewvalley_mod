...
public class ForagingLevelManager extends PersistentState {

    private static final String NAME = "stardewvalley_foraging";
    ...
    public static final Codec<FarmingData> DATA_CODEC = RecordCodecBuilder.create(instance ->
        instance.group(
    ...
    public static final Codec<ForagingLevelManager> CODEC = Codec.unboundedMap(
        Uuids.CODEC, DATA_CODEC
    ).xmap(
        map -> {
            ForagingLevelManager manager = new ForagingLevelManager();
    ...
    public static final PersistentStateType<ForagingLevelManager> TYPE = new PersistentStateType<>(
        NAME,
        ForagingLevelManager::new,
        SafeCodec.wrap(CODEC, ForagingLevelManager::new),
        DataFixTypes.LEVEL
    );
