...
public class MushroomStumpBlockEntity extends BlockEntity {
    private String outputItemId = "";

    public MushroomStumpBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.MUSHROOM_STUMP, pos, state);
    }
