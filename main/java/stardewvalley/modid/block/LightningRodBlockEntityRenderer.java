...
public class LightningRodBlockEntityRenderer implements BlockEntityRenderer<LightningRodBlockEntity, LightningRodRenderState> {

    private final ItemModelManager itemModelManager;

    public LightningRodBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        this.itemModelManager = ctx.itemModelManager();
    }

    @Override
    public LightningRodRenderState createRenderState() {
        return new LightningRodRenderState();
    }

    @Override
    public void updateRenderState(LightningRodBlockEntity entity, LightningRodRenderState renderState,
        ...
        if (blockState.get(LightningRodBlock.CHARGED)) {
            String itemId = entity.getChargedItemId();
        ...
        renderState.displayHeight = 1.85f;
    }

    @Override
    public void render(LightningRodRenderState renderState, MatrixStack matrices,
